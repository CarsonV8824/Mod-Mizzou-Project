...
class Database_manager():
    # Initialize the Database_manager with a connection to the SQLite database
    def __init__(self):
    ...
    # Create the save_data table if it doesn't exist
    def create(self):
    ...
    # Add a new high score entry to the save_data table
    ...
    # Update an existing high score entry in the save_data table
    ...
    # Delete the high score entry by resetting it to an empty dictionary
    def delete(self):
